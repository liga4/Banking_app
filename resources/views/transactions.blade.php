                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        @foreach($transactions as $transaction)
                            ...
                            @if($transaction->category == 'incoming')
                                    <td class="px-6 py-4 whitespace-nowrap text-green-600"> + {{ number_format($transaction->amount / 100, 2)." ". $account->currency }}</td>
                                @else
                                    <td class="px-6 py-4 whitespace-nowrap text-red-600"> - {{ number_format($transaction->amount / 100, 2)." ". $account->currency}}</td>
                                @endif
